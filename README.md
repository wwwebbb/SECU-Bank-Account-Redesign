...
It should be noted that both the full account website and mobile version of the account website are separate options listed on the [sign in page through 
...
of information as the mobile app. If my design were to be implemented, it would remove the need for two different sign in options via a user-friendly UI consistent across any screen size.
